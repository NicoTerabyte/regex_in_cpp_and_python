...
#define __PYX_HAVE__my_wrapper
#define __PYX_HAVE_API__my_wrapper
/* Early includes */
#include <string.h>
#include <string_view>
#include "ios"
...
/* Module declarations from "my_wrapper" */
...
static PyObject *__pyx_convert_vector_to_py_std_3a__3a_unordered_map_3c_std_3a__3a_string_2c_std_3a__3a_string_3e___(std::vector<std::unordered_map<std::string,std::string> >  const &); /*proto*/
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "my_wrapper"
extern int __pyx_module_is_main_my_wrapper;
int __pyx_module_is_main_my_wrapper = 0;

/* Implementation of "my_wrapper" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_10my_wrapper_parse_string(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_string_to_check); /* proto */
...
#define __pyx_kp_u_my_wrapper_pyx __pyx_string_tab[1]
#define __pyx_kp_u_utf_8 __pyx_string_tab[2]
#define __pyx_n_u_Pyx_PyDict_NextRef __pyx_string_tab[3]
#define __pyx_n_u_asyncio_coroutines __pyx_string_tab[4]
#define __pyx_n_u_byte_string __pyx_string_tab[5]
#define __pyx_n_u_c_result __pyx_string_tab[6]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[7]
#define __pyx_n_u_decode __pyx_string_tab[8]
#define __pyx_n_u_dictionary __pyx_string_tab[9]
#define __pyx_n_u_encode __pyx_string_tab[10]
...
#define __pyx_n_u_my_wrapper __pyx_string_tab[17]
#define __pyx_n_u_name __pyx_string_tab[18]
#define __pyx_n_u_parse_string __pyx_string_tab[19]
#define __pyx_n_u_pop __pyx_string_tab[20]
#define __pyx_n_u_python_result __pyx_string_tab[21]
#define __pyx_n_u_qualname __pyx_string_tab[22]
#define __pyx_n_u_retrieved_dict __pyx_string_tab[23]
#define __pyx_n_u_set_name __pyx_string_tab[24]
#define __pyx_n_u_setdefault __pyx_string_tab[25]
#define __pyx_n_u_string_to_check __pyx_string_tab[26]
...
#define __pyx_kp_b_iso88591_gQa_1_1_1_c_j_a_7_q_q_q __pyx_string_tab[30]
 ...
 *     return o
*/
    __pyx_t_1 = __pyx_convert_PyBytes_string_to_py_6libcpp_6string_std__in_string(__pyx_v_key_value->second); if (unlikely(!__pyx_t_1)) __PYX_ERR(1, 252, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
 ...
 * 
 * @cname("__pyx_convert_vector_to_py_std_3a__3a_unordered_map_3c_std_3a__3a_string_2c_std_3a__3a_string_3e___")             # <<<<<<<<<<<<<<
 * cdef object __pyx_convert_vector_to_py_std_3a__3a_unordered_map_3c_std_3a__3a_string_2c_std_3a__3a_string_3e___(const vector[X]& v):
 *     if v.size() > <size_t> PY_SSIZE_T_MAX:
*/

static PyObject *__pyx_convert_vector_to_py_std_3a__3a_unordered_map_3c_std_3a__3a_string_2c_std_3a__3a_string_3e___(std::vector<std::unordered_map<std::string,std::string> >  const &__pyx_v_v) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("__pyx_convert_vector_to_py_std_3a__3a_unordered_map_3c_std_3a__3a_string_2c_std_3a__3a_string_3e___", 0);
...
*/
    __pyx_t_2 = __pyx_convert_unordered_map_to_py_std_3a__3a_string____std_3a__3a_string((__pyx_v_v[__pyx_v_i])); if (unlikely(!__pyx_t_2)) __PYX_ERR(1, 91, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
...
*/
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_2);
  __Pyx_AddTraceback("vector.to_py.__pyx_convert_vector_to_py_std_3a__3a_unordered_map_3c_std_3a__3a_string_2c_std_3a__3a_string_3e___", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_o);
...
/* Python wrapper */
static PyObject *__pyx_pw_10my_wrapper_1parse_string(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static PyMethodDef __pyx_mdef_10my_wrapper_1parse_string = {"parse_string", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_10my_wrapper_1parse_string, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_10my_wrapper_1parse_string(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_v_string_to_check = 0;
  #if !CYTHON_METH_FASTCALL
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_string_to_check,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "parse_string", 0) < (0)) __PYX_ERR(0, 5, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("parse_string", 1, 1, 1, i); __PYX_ERR(0, 5, __pyx_L3_error) }
      }
    ...
    __pyx_v_string_to_check = values[0];
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("parse_string", 1, 1, 1, __pyx_nargs); __PYX_ERR(0, 5, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("my_wrapper.parse_string", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_10my_wrapper_parse_string(__pyx_self, __pyx_v_string_to_check);
...
static PyObject *__pyx_pf_10my_wrapper_parse_string(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_string_to_check) {
  PyObject *__pyx_v_byte_string = NULL;
  PyObject *__pyx_v_c_result = 0;
  PyObject *__pyx_v_python_result = NULL;
  PyObject *__pyx_v_dictionary = NULL;
  PyObject *__pyx_v_retrieved_dict = NULL;
 ...
 * 
*/
  __pyx_t_2 = __pyx_v_string_to_check;
 ...
 * 	python_result = []
*/
  __pyx_t_4 = __pyx_convert_string_from_py_6libcpp_6string_std__in_string(__pyx_v_byte_string); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L1_error)
  __pyx_t_1 = __pyx_convert_vector_to_py_std_3a__3a_unordered_map_3c_std_3a__3a_string_2c_std_3a__3a_string_3e___(find_match_for_regex(__PYX_STD_MOVE_IF_SUPPORTED(__pyx_t_4))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (!(likely(PyList_CheckExact(__pyx_t_1)) || __Pyx_RaiseUnexpectedTypeError("list", __pyx_t_1))) __PYX_ERR(0, 8, __pyx_L1_error)
  __pyx_v_c_result = ((PyObject*)__pyx_t_1);
  __pyx_t_1 = 0;
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_python_result = ((PyObject*)__pyx_t_1);
  __pyx_t_1 = 0;
...
*/
  __pyx_t_1 = __pyx_v_c_result; __Pyx_INCREF(__pyx_t_1);
  __pyx_t_5 = 0;
  for (;;) {
    {
    ...
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_XDECREF_SET(__pyx_v_dictionary, __pyx_t_2);
    __pyx_t_2 = 0;
...
*/
    ...
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_XDECREF_SET(__pyx_v_retrieved_dict, ((PyObject*)__pyx_t_2));
    __pyx_t_2 = 0;
...
*/
    ...
    __pyx_t_9 = __Pyx_dict_iterator(__pyx_v_dictionary, 0, __pyx_mstate_global->__pyx_n_u_items, (&__pyx_t_7), (&__pyx_t_8)); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 13, __pyx_L1_error)
    ...
    while (1) {
      ...
      if (unlikely(__pyx_t_11 == -1)) __PYX_ERR(0, 13, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_9);
...
*/
      ...
      __pyx_t_3 = 0;
      {
        ...
        __pyx_t_10 = __Pyx_PyObject_FastCallMethod((PyObject*)__pyx_mstate_global->__pyx_n_u_decode, __pyx_callargs+__pyx_t_3, (2-__pyx_t_3) | (1*__Pyx_PY_VECTORCALL_ARGUMENTS_OFFSET));
      ...
      __pyx_t_3 = 0;
      {
        PyObject *__pyx_callargs[2] = {__pyx_t_12, __pyx_mstate_global->__pyx_kp_u_utf_8};
        __pyx_t_9 = __Pyx_PyObject_FastCallMethod((PyObject*)__pyx_mstate_global->__pyx_n_u_decode, __pyx_callargs+__pyx_t_3, (2-__pyx_t_3) | (1*__Pyx_PY_VECTORCALL_ARGUMENTS_OFFSET));
        __Pyx_XDECREF(__pyx_t_12); __pyx_t_12 = 0;
        if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 14, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_9);
      }
      if (unlikely((PyDict_SetItem(__pyx_v_retrieved_dict, __pyx_t_9, __pyx_t_10) < 0))) __PYX_ERR(0, 14, __pyx_L1_error)
...
*/
      __pyx_t_13 = __Pyx_PyList_Append(__pyx_v_python_result, __pyx_v_retrieved_dict); if (unlikely(__pyx_t_13 == ((int)-1))) __PYX_ERR(0, 15, __pyx_L1_error)
    }
...
*/
  __Pyx_XDECREF(__pyx_r);
  __Pyx_INCREF(__pyx_v_python_result);
  __pyx_r = __pyx_v_python_result;
  goto __pyx_L0;
...
*/
  ...
  __Pyx_XDECREF(__pyx_v_c_result);
  __Pyx_XDECREF(__pyx_v_python_result);
  __Pyx_XDECREF(__pyx_v_dictionary);
  __Pyx_XDECREF(__pyx_v_retrieved_dict);
...
static int __pyx_pymod_exec_my_wrapper(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_my_wrapper},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_my_wrapper(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_my_wrapper(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_my_wrapper(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'my_wrapper' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "my_wrapper" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_my_wrapper", 0);
  ...
  if (__pyx_module_is_main_my_wrapper) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "my_wrapper")) {
      if (unlikely((PyDict_SetItemString(modules, "my_wrapper", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 * 	byte_string = string_to_check.encode("utf-8")
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_10my_wrapper_1parse_string, 0, __pyx_mstate_global->__pyx_n_u_parse_string, NULL, __pyx_mstate_global->__pyx_n_u_my_wrapper, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_parse_string, __pyx_t_2) < (0)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init my_wrapper", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init my_wrapper");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 7; } index[] = {{1},{14},{5},{20},{18},{11},{8},{18},{6},{10},{6},{8},{13},{5},{1},{8},{10},{10},{8},{12},{3},{13},{12},{14},{12},{10},{15},{8},{1},{6},{88}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (340 bytes) */
const char* const cstring = "BZh91AY&SY\212\300\241\354\000\000\025\377\373{\300\353\000 \023 \304\204\001p\001\277\377\377\340\300@@@@@@\000@@@\0000\001\rE\021\023iO\324C##OP4\000\000\000i\352f\247\2249\246&\000\023\000\023\000\000\230\000\t\203A\r#T\361\245\036\241\372\241\240\033P\000\006\207\250\036\242f\270\307\372\326R \017\300,h\205p:\00108D\211\\